...
const Home = () => {
  const [stats, setStats] = useState({ activeWriters: 0, monthlyReaders: 0 });
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setStats({
          activeWriters: res.data.total_users,
          monthlyReaders: res.data.total_blogs,
        });
      } catch (error) {
              ...
              <div className="space-y-6 md:space-y-8">
                <div className="inline-flex items-center px-4 py-1.5 bg-gray-100 rounded-full text-sm text-gray-600">
                  ...
                  <span className="hidden sm:inline">
                    Writing platform for modern creators
                  </span>
